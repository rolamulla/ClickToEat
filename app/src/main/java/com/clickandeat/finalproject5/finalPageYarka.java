...
public class finalPageYarka extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_final_page_yarka);

//        Intent i = new Intent(finalPageYarka.this,finalPageYarka.class);
//        String resName = i.getStringExtra("name");
        ...
        reference.child("4").child(resName).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
        ...
        reference.child("4").child(priorityRes).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
        ...
        backImg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                finalPageYarka.super.onBackPressed();
            }
        });
